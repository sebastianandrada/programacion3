...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2019 a las 03:01:57
...
CREATE TABLE `productos` (
  `pNumero` int(11) NOT NULL,
  `pNombre` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `proveedores`
  MODIFY `numero` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
COMMIT;
